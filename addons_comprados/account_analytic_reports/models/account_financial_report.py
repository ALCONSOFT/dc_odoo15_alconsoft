...
class ReportFinancial(models.AbstractModel):
    ...
    def get_account_lines(self, data):
        ...
        if used_context.get('analytic_account_ids'):
            used_context['analytic_account_ids'] = self.env['account.analytic.account'].browse(used_context.get('analytic_account_ids'))
    ...
    def get_report_values(self, docids, data=None):
        ...
        if data.get('form').get('used_context')['analytic_account_ids']:
            data.get('form').get('used_context')['analytic_account_ids'] = self.env['account.analytic.account'].browse(data.get('form').get('used_context')['analytic_account_ids'])
